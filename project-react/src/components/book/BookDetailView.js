                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mx-3">
                        ...
                        <div class="d-flex">
                            ...
                            <input class="form-control text-center border-dark" max={book.stock} id="inputQuantity" type="number" value={count} onChange={() => {
                                setCount(Number(document.getElementById("inputQuantity").value));
                            }} />
                        ...
                        <button class="btn btn-outline-dark flex-shrink-0" type="button"
                            onClick={(e) => {
                                if (sessionStorage.getItem("userId")) {
                                    const check = window.confirm(`"${book.name}" ${count}권을 주문하시겠습니까?`);
                                    if (check) {
                                        ...
                                        const result = axios({
                                            url: 'http://localhost:8080/order/book',
                                            method: 'post',
                                            data: formData
                                        });
